...
export default {
  data() {
    return {
      ...
      result: {"name":"hamburger","props":{"h3":"Props","table":{"headers":["参数","说明","类型","默认值","必填"],"rows":[["is-active","-","boolean","-","false"]]}},"emits":{"h3":"Emits","table":{"headers":["事件","说明","回调参数"],"rows":[["toggle-click","","-"]]}}}
    };
  },
};
</script>
