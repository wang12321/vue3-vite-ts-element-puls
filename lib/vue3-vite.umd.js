...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("vue")) : typeof define === "function" && define.amd ? define(["vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.component = factory(global.vue));
})(this, function(vue) {
  "use strict";
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-4e6f274c"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$3 = ["fill"];
  const _hoisted_2$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("path", { d: "M408 442h480c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8H408c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8zm-8 204c0 4.4 3.6 8 8 8h480c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8H408c-4.4 0-8 3.6-8 8v56zm504-486H120c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zm0 632H120c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zM142.4 642.1L298.7 519a8.84 8.84 0 0 0 0-13.9L142.4 381.9c-5.8-4.6-14.4-.5-14.4 6.9v246.3a8.9 8.9 0 0 0 14.4 7z" }, null, -1));
  const _hoisted_3$1 = [
    _hoisted_2$2
  ];
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      class: vue.normalizeClass([{ "is-active": _ctx.isActive }]),
      ...
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createElementVNode("div", {
          ...
          vue.renderSlot(_ctx.$slots, "default", {}, () => [
            !_ctx.dangerouslyUseHTMLString ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_2$1, vue.toDisplayString(_ctx.message), 1)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
  ...
  const message = function(options = {}) {
    ...
    const vm = vue.createVNode(script, props, vue.isVNode(props.message) ? { default: () => message2 } : null);
    vm.props.onDestroy = () => {
  ...
  */
  ...
  const _sfc_main$1 = vue.defineComponent({
    ...
    setup() {
      ...
      return __spreadValues({}, vue.toRefs(state));
    }
  });
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
      _ctx.isFullscreen ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
  ...
  function index(app) {
    Object.keys(files).forEach((fileName) => {
      ...
      const module2 = files[fileName];
      const moduleName = fileName.replace(/^\.\/(.*)\/(.*)\.\w+$/, "$1");
      app.component(moduleName, module2.default || module2);
    });
  }
  return index;
});
